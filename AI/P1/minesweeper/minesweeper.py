    ...
    def add_knowledge(self, cell, count):
        ...
        for x in offset:
            ...
            if newcell in self.mines:
                potential_count -= 1
            elif 0 <= row < self.height and 0 <= column < self.width and newcell not in self.safes:
                potential_mines.add(newcell)

        if not potential_mines:
            return
        ...
        while change:
            ...
            for s in self.knowledge:
                kmines = s.known_mines().copy()
                ksafes = s.known_safes().copy()
